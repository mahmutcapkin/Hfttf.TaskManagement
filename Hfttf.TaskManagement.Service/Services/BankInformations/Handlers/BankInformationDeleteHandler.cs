...
{
    public class BankInformationDeleteHandler : BaseBankInformationHandler, IRequestHandler<BankInformationDeleteCommand, Response>
    {
        public BankInformationDeleteHandler(IBankInformationRepository BankInformationRepository) : base(BankInformationRepository)
        {

        }
        public async Task<Response> Handle(BankInformationDeleteCommand request, CancellationToken cancellationToken)
        {
            var bankInformation = TaskManagementMapper.Mapper.Map<BankInformation>(request);
            var response = await _bankInformationRepository.DeleteAsync(bankInformation);
